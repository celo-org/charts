...
- [succinct-game-monitor-embedded](./charts/succinct-game-monitor-embedded/README.md) - Single in-process OP Succinct game monitor. Discovers fault-dispute games on-chain and runs cost-estimation (witness generation + SP1 prove) in one process, bounded by a shared cgroup memory budget. Replaces the subprocess-based succinct-game-monitor.
- [sync-test](./charts/sync-test/README.md) - Umbrella chart for running OP-Stack sync tests

...
A Helm chart to run pr-url-checker-app at cLabs
...
* <https://github.com/celo-org/pr-url-checker-app>
...
| image.repository | string | `"us-west1-docker.pkg.dev/devopsre/pr-url-checker-app/pr-url-checker-app"` | Image repository |

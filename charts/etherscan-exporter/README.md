...
A Helm chart for etherscan-exporter
...
| env.apiToken | string | `"etherscan-api-key"` | Env. Var API_KEY. Won't be used if apiKeyExistingSecret is defined |
| env.apiTokenExistingSecret | string | `"etherscan-api-key"` | Existing secret for Env. Var API_KEY. |
| env.chainID | string | `"1"` | Chain ID to get blocks from. |
...
| image.repository | string | `"us-west1-docker.pkg.dev/devopsre/etherscan-exporter/etherscan-exporter"` | Image repository |

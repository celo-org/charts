# akeyless-gadmin-producer

Deploys Akeyless Google Admin producer.
...
Chart is released to oci://us-west1-docker.pkg.dev/devopsre/clabs-public-oci/akeyless-gadmin-producer repository automatically every commit to `main` branch.

...
| blockscout.shared.image | object | `{"pullPolicy":"Always","repository":"gcr.io/celo-testnet/blockscout","tag":"v2.0.4-beta-celo"}` | Image to use for blockscout components |
